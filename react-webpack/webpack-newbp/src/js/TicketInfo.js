...
var { Segment, Input, Checkbox, TextArea, Icon, Reveal, Card, Image } = require('semantic-ui-react');
        ...
        return (
            <div>
                ...
                <div className='hidden'>
                    <Card fluid>
                        <Image src='./lib/img/404.png' />
                        <Card.Content>
                            <Card.Header>暂无机票信息</Card.Header>
                            <Card.Description>没有选择出差任务单,或出差任务单无对应机票信息</Card.Description>
                        </Card.Content>
                    </Card>
                </div>
            </div>
