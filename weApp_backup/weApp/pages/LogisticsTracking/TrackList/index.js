...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'http://wechat.casco.com.cn:9004/Point/MyK2AdviceDeliveryInfo',
      method: 'GET',
      data: {
      ...
      success: function (res) {
        ...
        that.setData({
          DeliveryInfo: res.data.rows,
          DeliveryDetailLists: res.data.rows1,
          DeliveryTarckLists: res.data.rows2,
          hiddenView: data,
          itemslength: length
        })
      }
  ...
  showDetail: function (e) {
    ...
    wx.navigateTo({
      url: "/pages/LogisticsTracking/TrackInfo/index?ProcInstId=" + ProcInstId + ""
    })
  },
